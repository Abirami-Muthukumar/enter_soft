...
use Modules\ModuleManager\Entities\acsModuleManager;
...
//        Log::info($message);
    ...
    {
        $css_path = 'public/frontend/acslmstheme/css/custom.css';
        $js_path = 'public/frontend/acslmstheme/js/custom.js';
        File::put($css_path, "");
        File::put($js_path, "");
    }
    ...
    {
        try {
            acsModuleManager::updateOrCreate([
                'name' => $name,
            ], [
                'name' => $name,
