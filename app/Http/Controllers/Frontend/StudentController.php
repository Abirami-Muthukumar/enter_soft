...
use Modules\Assignment\Entities\acsAssignAssignment;
use Modules\Assignment\Entities\acsAssignment;
...
class StudentController extends Controller
{
    ...
    public function myAssignmentDetails($id)
    {
        ...
        try {
            ...
            $assign_assignment = acsAssignAssignment::where('student_id', Auth::user()->id)->where('id', $id)->first();
            if ($assign_assignment == null) {
                Toastr::error(trans('common.Operation failed'), trans('common.Failed'));
                return redirect()->back();
            }
            $assignment_info = acsAssignment::where('id', $assign_assignment->assignment_id)->first();
...
//            Auth::logout();
    ...
    {
        $badges = CourseBadge::where('user_id',Auth::id())->with('user:id,name','course:id,course_badge')->get();
