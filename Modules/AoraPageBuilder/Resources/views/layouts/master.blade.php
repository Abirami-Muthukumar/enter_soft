...
//            $currentTheme ='acslmstheme';
//
//        }
    @endphp
    @if ($currentTheme == 'acslmstheme')
        @if(isRtl())
            <link rel="stylesheet"
        ...
        @endif
        <link rel="stylesheet"
              href="{{ asset('public/frontend/acslmstheme') }}/css/fontawesome.css{{ assetVersion() }} "
              data-type="aoraeditor-style">

        <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme/css/app.css') . assetVersion() }}"
              data-type="aoraeditor-style">

        @if(isRtl())
            <link rel="stylesheet" type="text/css" data-type="aoraeditor-style"
                  href="{{ asset('public/frontend/acslmstheme/css/frontend_style_rtl.css') . assetVersion() }}">
        @else
            <link rel="stylesheet" type="text/css" data-type="aoraeditor-style"
                  href="{{ asset('public/frontend/acslmstheme/css/frontend_style.css') . assetVersion() }}">
        @endif

        <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme/css/mega_menu.css') }}">

        {{-- <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme/css/sections/base.css') }}"
              data-type="aoraeditor-style"> --}}


        <link rel="stylesheet" href="{{ asset('public/css/preloader.css') }}"/>
        <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme/css/custom.css') }}">
    ...
    <script type="text/javascript"
            src="{{ asset('public/frontend/acslmstheme/js/jquery.lazy.min.js') }}"></script>
