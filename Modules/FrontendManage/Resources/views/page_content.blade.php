                                ...
                                <div class="col-md-6 ">
                                 ...
                                 {{--    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                @if(currentTheme() == 'acslmstheme' || currentTheme() == 'wetech' || currentTheme() == 'teachery')
                                            ...
                                            <div
                                                class="row pt-0  {{(currentTheme() == 'acslmstheme') ? 'd-none' : ''}}">
                                                @if(isModuleActive('FrontendMultiLang'))
                                                    <ul class="nav nav-tabs no-bottom-border  mt-sm-md-20 mb-10 ms-3"
                                                        role="tablist">
                                                        @foreach ($LanguageList as $key => $language)
                                            ...
                                            <div
                                                class="tab-content  {{(currentTheme() == 'acslmstheme') ? 'd-none' : ''}}">
                                                @foreach ($LanguageList as $key => $language)
                                                    <div role="tabpanel"
                                                         class="tab-pane fade @if (auth()->user()->language_code == $language->code) show active @endif  "
