...
class FrontendPageDesignAdd extends Migration
{
    ...
    {
        $imagePath = asset('public/frontend/acslmstheme/img/new_bread_crumb_bg.png');
...
<p>This privacy policy explains how <b>acsLMS APP</b>  use and protect the information we hold, whether it relates to the Educational Institution, students, parents, its staff and third party service providers in connection with our business and has been developed . This privacy policy does not require any physical, electronic or digital signature. We are committed to maintaining the privacy of our students, parents, teachers and other users of our website/application.</p>
<br>
<p>This privacy policy governs your use of the application <b>acsLMS APP</b>. By entering to this Website or downloading the app via Play Store /App Store you agree to be bound by the terms and conditions of this Privacy Policy. If you do not agree, please do not use or access our website/application. By mere use of the website/application, you expressly consent to our use and disclosure of your personal information in accordance with this Privacy Policy. It is incorporated into and subject to the Terms and Conditions.</p>
<br>
...
<p>Needed information means information about an educational institute or identifiable individual or information that permits an individual to be identified. </p>
            ...
            <p><b>acsLMS APP</b> is a smart software service, it takes responsibility for maintaining and protecting the personal information under our control.</p>
...
It will help us prevent, detect, mitigate, and investigate fraud, security breaches, potentially prohibited or illegal activities. It will also be used to enforce our Privacy Notice, our User Agreement or other policies.
          ...
          <br>  <p>Under no circumstances do we rent, trade or share the institutional/personal information that we have collected with any other company for their marketing purposes without your consent. We reserve the right to communicate your personal information to any third party that makes a legally-compliant request for its disclosure.</p>
            ...
            <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. <b>acsLMS APP</b> to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>
