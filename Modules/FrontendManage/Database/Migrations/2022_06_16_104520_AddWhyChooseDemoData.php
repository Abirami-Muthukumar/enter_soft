...
class AddWhyChooseDemoData extends Migration
{
    public function up()
    {
        ...
        WhyChoose::create([
            ...
            'image'=>'public/frontend/acslmstheme/img/icon/icon_Customized_Study_plans.png',
        ]);

        WhyChoose::create([
            'title'=>'Subjects On Demand',
            'sub_title'=>'Add on any subjects at any time on your package.',
            'image'=>'public/frontend/acslmstheme/img/icon/icon_Subjects_On_Demand.png',
        ]);
        ...
        WhyChoose::create([
            ...
            'image'=>'public/frontend/acslmstheme/img/icon/icon_Parental_Engagement.png',
        ]);

        WhyChoose::create([
            'title'=>'Live & Interactive Learning',
            'sub_title'=>'Diagnostic assessments to understand student’s abilities and provide personalized lesson plans.',
            'image'=>'public/frontend/acslmstheme/img/icon/icon_Live_and_Interactive_Learning.png',
        ]);

        WhyChoose::create([
            'title'=>'Outstanding Tutors and Guaranteed Results',
            'sub_title'=>'Add on any subjects at any time on your package',
            'image'=>'public/frontend/acslmstheme/img/icon/icon_Outstanding_Tutors_and_Guaranteed_Results.png',
        ]);

        WhyChoose::create([
            'title'=>'Parental Engagement',
            'sub_title'=>'Parents are given constructive feedback from tutors after each lesson',
            'image'=>'public/frontend/acslmstheme/img/icon/icon_Parental_Engagement_2.png',
        ]);
    }
