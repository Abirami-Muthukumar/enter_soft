    ...
    public function up()
    {
        Schema::table('login_pages', function ($table) {
            ...
            if (!Schema::hasColumn('login_pages', 'reg_title')) {
                $table->string('reg_title')->default('Welcome to acs Learning Management System');
            }
            if (!Schema::hasColumn('login_pages', 'reg_title')) {
                $table->string('reg_banner')->default('public/frontend/acslmstheme/img/banner/global.png');
            }
            if (!Schema::hasColumn('login_pages', 'reg_title')) {
            ...
            if (!Schema::hasColumn('login_pages', 'forget_title')) {
                $table->string('forget_title')->default('Welcome to acs Learning Management System');
            }
            if (!Schema::hasColumn('login_pages', 'forget_title')) {
                $table->string('forget_banner')->default('public/frontend/acslmstheme/img/banner/global.png');
            }
            if (!Schema::hasColumn('login_pages', 'forget_title')) {
