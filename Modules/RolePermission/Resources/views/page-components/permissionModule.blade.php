                            ...
                            <li>
                                <div class="submodule">
                                    <input id="Sub_Module_{{ $SubMenu->id }}" name="module_id[]"
                                           value="{{ $SubMenu->id }}"
                                           class="acs_csk common-radio  module_id_{{ $Module->id }} module_link"
                                            ...
                                            <li>
                                                <div class="module_link_option_div" id="{{ $SubMenu->id }}">
                                                    <input id="Option_{{  $action->id }}" name="module_id[]"
                                                           value="{{  $action->id }}"
                                                           class="acs_csk common-radio module_id_{{ $Module->id }} module_option_{{ $Module->id }}_{{ $SubMenu->id }} module_link_option"
