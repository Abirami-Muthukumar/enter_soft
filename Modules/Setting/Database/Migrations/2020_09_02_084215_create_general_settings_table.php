...
class CreateGeneralSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('general_settings', function (Blueprint $table) {
            $table->id();
            $table->string('site_title')->nullable()->default('acs LMS');
            ...
            $table->string('copyright_text')->default('Copyright © 2024 acsLMS. All rights reserved');
        ...
        DB::table('general_settings')->insert([
            [
                ...
                'zip_code' => '1205',
                'active_status' => '1',
                'copyright_text' => 'Copyright © 2024 acsLMS. All rights reserved | Made By CodeThemes ',
                'footer_copy_right' => 'Copyright © 2024 acsLMS. All rights reserved | Made By  <a href="https://aorasoft.com" target="_blank"><span style="color:var(--system_primery_gredient1, #BF37FF)">CodeThemes</span></a>',                'created_at' => now(),
                'updated_at' => now(),
            ]
        ]);
