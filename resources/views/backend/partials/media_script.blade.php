<script>
    ...
    Amaz.uploader = {
            ...
            setTimeout(function () {
                ...
                if (data.length > 0) {
                    for (let i = 0; i < data.length; i++) {
                        ...
                        let html = `
                            <div class="acslms_file_body single_files" aria-hidden="${data[i].aria_hidden}" data-selected="${data[i].selected}">
                                <div class="modal_file_box" data-value="${data[i].id}">
                                    <div class="img-box">
                                        ${thumb}
                                    </div>
                                    <div class="acslms_file_content-box">
        ...
        trigger: function (
            ...
            $.post(
                ...
                function (data) {
                    ...
                    $('[data-bs-toggle="acsUploaderAddSelected"]').on(
                        "click",
                        function (e) {
                            e.preventDefault();
                            if (from === "input") {
        ...
        initForInput: function () {
            $(document).on("click", '[data-bs-toggle="acsUploader"]', function (e) {
                e.preventDefault();
                if (e.detail === 1) {
                    var elem = $(this);
        ...
        previewGenerate: function () {
            ...
            $('[data-bs-toggle="acsUploader"]').each(function () {
                let $this = $(this);
        ...
        removeAttachment: function () {
            $(document).on("click", '.img_remove_btn', function (e) {
                ...
                let selected = $(this)
                    ...
                    .prev('[data-bs-toggle="acsUploader"]')
                    .find(".selected_files")
                    .val()
                    .split(",")
                    .map(Number);
        ...
        sortImage: function () {
            $(".product_image_all_div").sortable({
                ...
                update: function (event, ui) {
                    ...
                    $(this).prev('[data-bs-toggle="acsUploader"]').find('.selected_files').val(imageids.join(','));
                }
            });
        }
