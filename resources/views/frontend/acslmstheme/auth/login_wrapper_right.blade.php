...
<div class="login_wrapper_right">
    <div class="login_main_info">
        <h3><b>Cyber Security Micro-credential for Educators 
            </b>
        </h3>
        <!-- <h3><b>Empowering Educators with</b></h3><h3><b>Cyber Security Skills</b></h3> -->
       <!-- <h4>
            {{$title??'Welcome to acs Learning Management System'}}
        </h4> -->

        <div class="thumb">
            <img src="{{asset($banner??'public/frontend/acslmstheme/img/banner/global.png')}}" alt="">
        </div>
