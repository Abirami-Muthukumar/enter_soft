...
<style type="text/css">
    ...
    <div class="login_wrapper">
        @include('frontend.acslmstheme.auth.login_wrapper_right')
        <div class="login_wrapper_left">
            ...
            <div class="login_wrapper_content text-center">
                        ...
                        <div class="col-12 mt_20">
                            <div class="input-group custom_group_field">
                                ...
                                <input type="password" name="password" class="form-control"
                                       ...
                                       aria-describedby="basic-addon4" id="password">
            ...
            @if(Settings('student_reg')==1 && saasPlanCheck('student')==false)
                <h5 class="text-center mb-0">{{__("frontend.Don’t have an account")}}? <a style="color: #5dabfc" href="{{route('register')}}">
                        {{__('common.Register')}}
                    </a></h5>
            @endif
