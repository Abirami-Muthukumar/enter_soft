...
<link rel="stylesheet" href="{{asset('public/frontend/acslmstheme/css/homepageV7/footer-v7.css')}}">
@php
...
<style>
    * {
    ...
    .custom-footer {
        background: linear-gradient(to right, #001c71, #5a1a40, #751f3d); /* Gradient extracted from image */
        color: white;
        padding: 160px 10%;
        text-align: center;
    }
...
<div class="custom-footer">
    <div class="footer-content">
        <div class="footer-logo">
          <a href="{{route('studentDashboard')}}"> <img src="{{getCourseImage(Settings('logo2'))}}" alt="Logo"> </a> <!-- Replace with your logo -->
        </div>
    ...
    <div class="footer-bottom">
       {!! function_exists('footerSettings')?footerSettings('footer_copy_right'):''  !!}
    </div>
</div>
{{--- <footer
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <p class="bold">{!! function_exists('footerSettings')?footerSettings('footer_copy_right'):''  !!}</p>
                </div>
            </div>
        </div>
        <div class="row">
