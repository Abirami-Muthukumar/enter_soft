...
<div class="aoraeditor-skip aoraeditor-footer">
    ...
    <script src="{{ asset('public/frontend/acslmstheme/js/map.js') }}"></script>
    <script src="{{asset('public/frontend/acslmstheme/js/contact.js')}}{{assetVersion()}}"></script>
    ...
    @if (isModuleActive("Store"))
        <script src="{{asset('public/frontend/acslmstheme/js/store_script.js')}}{{assetVersion()}}"></script>
    ...
    <script src="{{ asset('public/frontend/acslmstheme/js/custom.js') }}{{assetVersion()}}"></script>
