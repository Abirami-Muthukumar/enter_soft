<link rel="stylesheet" href="{{asset('public/frontend/acslmstheme/plugins/drawflow/drawflow.css')}}">
...
<script src="{{asset('public/frontend/acslmstheme/plugins/drawflow/drawflow.js')}}"></script>
