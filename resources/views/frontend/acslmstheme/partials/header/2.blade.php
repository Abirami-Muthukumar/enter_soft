...
<link rel="stylesheet" href="{{asset('public/frontend/acslmstheme/css/homepageV7/header-v7.css')}}">
            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-3">
                         <a href="{{route('studentDashboard')}}" class="heading-logo d-block">

                            <img src="{{getLogoImage(Settings('logo') )}}" class="home d-block" alt="acs LMS">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
    <div class="offcanvas-header d-flex justify-content-between">
        <a href="{{url('/')}}" class="heading-logo d-block">
            <img src="{{getLogoImage(Settings('logo') )}}" alt="acs LMS">
        </a>
