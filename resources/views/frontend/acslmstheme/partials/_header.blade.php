...
<head>
    ...
    @if(isRtl())
        <link rel="stylesheet"
              href="{{ asset('public/frontend/acslmstheme') }}/css/bootstrap.rtl.min.css{{assetVersion()}} ">
    @else
        <link rel="stylesheet"
              href="{{ asset('public/frontend/acslmstheme') }}/css/bootstrap.min.css{{assetVersion()}} ">
    @endif

    <link rel="stylesheet" href="{{asset('public/backend/css/themify-icons.css')}}{{assetVersion()}}"/>
    <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme') }}/css/notification.css{{assetVersion()}}">
