...
@section('title')
    {{Settings('site_title')  ? Settings('site_title')  : 'acs LMS'}} | {{__('frontend.My Questions')}}
@endsection
@section('css')
    <link rel="stylesheet"
          href="{{ asset('public/frontend/acslmstheme/plugins/data-table/jquery.dataTables.min.css') }}">
    <style>
        .dataTables_paginate {
            float: right;
            padding-top: 20px;
...
@endsection
@section('js')
    <script src="{{ asset('public/frontend/acslmstheme/plugins/data-table/jquery.dataTables.min.js') }}"></script>
