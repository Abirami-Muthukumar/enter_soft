...
@section('css')
    ...
    <link href="{{asset('public/frontend/acslmstheme/css/videopopup.css')}}{{assetVersion()}}" rel="stylesheet"/>
    <link href="{{asset('public/frontend/acslmstheme/css/video.popup.css')}}{{assetVersion()}}" rel="stylesheet"/>
