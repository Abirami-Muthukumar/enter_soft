...
@section('title')
    {{Settings('site_title')  ? Settings('site_title')  : 'acs LMS'}} | {{__('ticket.support_ticket')}}
@endsection
@section('css')

    <link rel="stylesheet" href="{{asset('public/frontend/acslmstheme/css/support.css')}}{{assetVersion()}}">
@endsection
@section('js')
    <script src="{{asset('public/frontend/acslmstheme/js/support.js')}}{{assetVersion()}}"></script>
@endsection
