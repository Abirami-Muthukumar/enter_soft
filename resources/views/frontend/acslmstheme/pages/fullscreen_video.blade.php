...
@section('title')
    ...
    {{Settings('site_title')  ? Settings('site_title')  : 'acs LMS'}} | {{ $course->title}}
...
@section('css')
    ...
    <link href="{{asset('public/frontend/acslmstheme/css/full_screen.css')}}{{assetVersion()}}" rel="stylesheet"/>
                        ...
                        <div class="header__wrapper flex-wrap ">
                            ...
                            <div class="header__left d-flex ">
                                ...
                                <div class="">
                                    ...
                                    <a class="logo_img" href="{{route('studentDashboard')}}">
                              ...
                              <div class="category_search d-none d-lg-flex category_box_iner header__center ">
                                                            ...
                                                            <label class="primary_checkbox2 d-flex">
                                                                ...
                                                                <div class="icon">
                                                                    ...
                                                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        ...
                                                                        <path d="M1.61719 9.18847L5.78764 13.4892C7.75009 7.85194 9.38446 5.37824 13.0859 2.02051" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                                            ...
                                                            <label class="primary_checkbox2 error_ans d-flex">
                                                                ...
                                                                <div class="icon">
                                                                    ...
                                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        ...
                                                                        <path d="M1.75781 10.2427L10.2431 1.75739" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>

                                                                        <path d="M10.2431 10.2426L1.75781 1.75732" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            @if (isModuleActive('Assignment'))
                ...
                @php
                    ...
                    if (Auth::check()) {
                        ...
                        $submit_info = Modules\Assignment\Entities\acsSubmitAssignment::assignmentLastSubmitted($assignment_info->id, Auth::user()->id);
        ...
        @else
            ...
            @if ($lesson->host == 'Youtube')
                ...
                @else
                    ...
                    <link href="{{ asset('public/frontend/acslmstheme/plugins/css/jquery.mb.YTPlayer.min.css') }}"

                          media="all" rel="stylesheet" type="text/css">



                    <script src="{{ asset('public/frontend/acslmstheme/plugins/jquery.mb.YTPlayer.js') }}"></script>
            ...
            @if ($lesson->host == 'PDF')
                ...
                <script src="{{ asset('public/frontend/acslmstheme/js/pdf.min.js') }}"></script>

                <script src="{{ asset('public/frontend/acslmstheme/js/pdfjs-viewer.js') }}"></script>

                <script src="{{ asset('public/frontend/acslmstheme/js/zoom.js') }}"></script>

                <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme/css/pdfjs-viewer.css') }}"/>
                ...
                <script>
                    ...
                    pdfjsLib.GlobalWorkerOptions.workerSrc = '{{ asset('public/frontend/acslmstheme/js/pdf.worker.min.js') }}';
        ...
        <div class="floating-title position-fixed">
            ...
            <p class="font_16 d-flex align-items-center">
                ...
                <span class="header__common_btn me-2 play_toggle_btn"><i
                        ...
                        class="ti-menu-alt"></i></span>4 Modules <!-- {{ @$total }} {{ __('common.Lessons') }} -->
...
@push('js')
    ...
    <script src="{{ asset('public/frontend/acslmstheme/js/app.js') }}{{assetVersion()}}"></script>
    ...
    <script src="{{ asset('public/frontend/acslmstheme/js/full_screen_video.js') }}"></script>

    @if ($lesson->is_quiz == 1)

        @if (!$result)

            <script src="{{ asset('public/frontend/acslmstheme/js/quiz_start.js') }}"></script>
