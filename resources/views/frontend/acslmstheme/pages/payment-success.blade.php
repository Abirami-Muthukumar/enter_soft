...
@section('title')
    {{Settings('site_title')  ? Settings('site_title')  : 'acs LMS'}} | @lang('frontend.Payment Success')
@endsection
@section('js')
    <script src="{{asset('public/frontend/acslmstheme/js/lottie-player.min.js')}}"></script>
    <script>
    </script>
@endsection
@section('css')
                    ...
                    <div class="content">
                        ...
                        <div class="text-center">
                            <div class="success-image">
                                <lottie-player
                                    src="{{asset('public/frontend/acslmstheme/img/success-animation.json')}}"
