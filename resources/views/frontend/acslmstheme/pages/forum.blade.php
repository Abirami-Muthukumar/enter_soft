...
@section('title')
    {{Settings('site_title')  ? Settings('site_title')  : 'acs LMS'}} | {{__('forum.Forum')}}
@endsection
@section('css')
    <link rel="stylesheet" href="{{asset('public/frontend/acslmstheme/css/forum.css')}}{{assetVersion()}}">
@endsection
@section('js')
    <script src="{{asset('public/frontend/acslmstheme/js/forum.js')}}"></script>
@endsection

@section('mainContent')

   <x-breadcrumb :banner="trans('common.N/A')"
                  :title="trans('Educators` forum: connect, share, learn')"
                            ...
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table class="table fourm_table mb-0">
                                        <thead>
                                        <tr >
                                            <th  style="background-color: #333bc3;color: white;">{{__('courses.Course')}}</th>
                                            <th  style="background-color: #333bc3;color: white;">{{__('common.User')}}</th>
                                            <th  style="background-color: #333bc3;color: white;">{{__('courses.Category')}}</th>
                                            <th  style="background-color: #333bc3;color: white;">{{__('forum.Replies')}}</th>
                                            <th  style="background-color: #333bc3;color: white;">{{__('forum.Views')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
