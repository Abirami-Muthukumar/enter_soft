...
@section('title')
    {{Settings('site_title')  ? Settings('site_title')  : 'acs LMS'}} | {{__('frontendmanage.My Profile')}}
@endsection
@section('css')
...
@section('js')
    ...
    <script src="{{ asset('public/frontend/acslmstheme/js/my_profile.js') }}{{assetVersion()}}"></script>
