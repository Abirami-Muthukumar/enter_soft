...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme') }}/css/fluidplayer.min.css">

    {{--    <link rel="stylesheet" href="{{asset('public/backend/css/style.css')}}"/>--}}
    <link rel="stylesheet" href="{{asset('public/css/preloader.css')}}"/>
    @if(isRtl())
        <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme') }}/css/bootstrap.rtl.min.css">
    @else
        <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme') }}/css/bootstrap.min.css">
    @endif

    <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme') }}/css/app.css">
    <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme') }}/css/fontawesome.css ">
    <link rel="stylesheet" href="{{asset('public/backend/css/themify-icons.css')}}"/>
    @if(isRtl())
        <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme') }}/css/frontend_style_rtl.css">
    @else
        <link rel="stylesheet" href="{{ asset('public/frontend/acslmstheme') }}/css/frontend_style.css">
    @endif
    <script src="{{asset('public/frontend/acslmstheme')}}/js/common.js{{assetVersion()}}"></script>
    {{-- <script src="{{asset('public/frontend/acslmstheme/js/app.js')}}"></script> --}}
    @yield('css')
    <script>
...
<script src="{{ asset('public/frontend/acslmstheme') }}/js/fluidplayer.min.js"></script>
