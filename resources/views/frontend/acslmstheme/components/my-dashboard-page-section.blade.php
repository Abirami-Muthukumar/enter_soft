...
.dotted-list li::before {
    ...
    <div class="main_content_iner main_content_padding">
        ...
        <p class="text-black">This micro-credential supports teacher professional development on the privacy and security section of the Australian Digital Technologies Curriculum.
</p><br>                                                    <p>Course Progress</p>
                                                    ...
                                                    <a href="{{route('continueCourse',[$course->slug])}}"
                                                       ...
                                                       class="theme_btn">Resume Course</a>
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4 width-400">

        <div class="card_width dashboard_card  p-3">

            <div class="icon mx-auto">

                <b style="font-size: 27px;">Module 1</b>
 ...
 and how it strengthens password security.
                 </li>
                 <li>
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        ...
        <div class="card_width dashboard_card  p-3">
            ...
            <div class="icon mx-auto">
                ...
                <b style="font-size: 27px;">Module 2</b>

            </div>
           <div class="dotted-list ">
             <ul>
                 <li>
                     Explore cyber threat models.
                 </li>
                 <li  >
                      Recognise vulnerabilities in digital systems.

                 </li>
             </ul> 
         </div>
          <!--   <span>Explore different cyber threat models and their impact on security. Recognise vulnerabilities in digital systems and how to mitigate risks.</span> -->
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        ...
        <div class="card_width dashboard_card  p-3">
            ...
            <div class="icon mx-auto">
                ...
                <b style="font-size: 27px;">Module 3</b>

            </div>
            <div class="dotted-list ">
             <ul>
                 <li>
                   Learn how digital footprints collect user data.

                 </li>
                 <li>
                      Consider how essential data collected.

                 </li>
             </ul> 
         </div>
            <!-- <span>Learn how digital footprints are created and how to manage them. Understand the risks of personal and professional data exposure online.</span> -->
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        ...
        <div class="card_width dashboard_card  p-3">
            ...
            <div class="icon mx-auto">
                ...
                <b style="font-size: 27px;">Module 4</b>

            </div>
            <div class="dotted-list ">
             <ul>
                 <li>
                    Gain knowledge of the Australian Privacy Principles (APPs).
                 </li>
                 <li>
                     Learn how privacy laws apply in organisations to keep user data safe.

                 </li>
             </ul> 
         </div>
            <!-- <span>Gain knowledge of the Australian Privacy Principles (APPs). Learn how privacy laws apply in educational settings and protect student data.</span> -->
