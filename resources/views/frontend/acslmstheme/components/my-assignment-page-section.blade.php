                                                ...
                                                @foreach ($assignment_list as $key=>$assign)
                                                    @php
                                                        if (isModuleActive('Assignment')){
                                                            $submit_info=Modules\Assignment\Entities\acsAssignAssignment::assignmentLastSubmitted($assign->id);

                                                        }elseif(isModuleActive('Homework')){
                                                             $submit_info=Modules\Homework\Entities\acsAssignHomework::assignmentLastSubmitted($assign->id);
                                                        }else{
                                                            $submit_info=null;
                                                        }
                                                    @endphp
