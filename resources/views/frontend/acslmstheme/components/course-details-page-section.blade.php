                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <h2 class="title text-black">
                            ...
                            Cyber Security Micro-credential<br>for Educators
                        ...
                        <p class="location text-black">



                           <!--  <span>ACS has partnered with Entersoft to deliver the Cyber Security for Educators. This microcredential has been developed to support teacher professional development on the cyber privacy and security section of the Digital Technologies Curriculum.</span> -->
                       ...
                       <!--  <ul class="d-flex gap-12 flex-wrap align-items-center category">
                             ...
                             <li class="category_item text-black">ACS has partnered with Entersoft to deliver the Cyber Security for Educators. This microcredential has been developed to support teacher professional development on the cyber privacy and security section of the Digital Technologies Curriculum.</li>
                            ...
                            <li class="meta_item">
                                ...
                                <div class="rating d-flex gap-1">
                                    ...
                                    @if ($main_stars>$stars)
                                        ...
                                        <img src="{{asset('public/frontend/acslmstheme/img/svg/half_star.svg')}}"
                                            ...
                                            <div class="course_overview_description">
                                                ...
                                                <div class="single_overview">
                                                   ...
                                                   <!--  @if(!empty($course->requirements))
                                                    ...
                                                    <h4 class="font_32 f_w_700 mb_20">Description</h4>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <div class="table-responsive dotted-list">
                                                 ...
                                                 <?php $i=1; ?>
                                                    ...
                                                    @foreach($course->chapters as $chapter)
                                                        ...
                                                        <div class="accordion-item">
                                                            ...
                                                            <div class="collapViewse" id="collapse{{$chapter->id}}"
                                                                ...
                                                                <div class="accordion-body">
                                                                    ...
                                                                    <div class="curriculam_list">
                                                                        ...
                                                                        @foreach($chapter->lessons as $key=>$lesson)
                                                                          ...
                                                                          @foreach(explode("\n", $lesson->description) as $paragraph)
                                                                             <p>{{ $paragraph }}</p>
                                                                           @endforeach
...
<!-- 
 ...
 -->
                                                                                                    ...
                                                                                                    <!-- <span onclick="goFullScreen({{$course->id}},{{$lesson->id}})"> {{@$key+1}} {{@$lesson->name}}</span> -->
                        ...
                        <div class="course_sidebar">
                            ...
                            <div class="sidebar__widget">
                                                    ...
                                                    <div class="card ">
                                                        ...
                                                        <div class="info">
                                                            ...
                                                            <div class="item">
                                                                ...
                                                                <span class="text">Self-Paced</span>



                                                                <span class="value">4 Modules</span>
                                                            ...
                                                            <div class="item">
                                                                ...
                                                                <span class="text">Digital Certificate</span>
                                                ...
                                                @else
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <a href="javascript:void(0)">
                                                            ...
                                                            <span class="play-icon">▶</span>>Enrol Now
                              ...
                              <!--   <ul class="course_includes">
                                ...
                                {{--                                    <img src="{{asset('public/frontend/acslmstheme/svg/video.svg')}}" alt="">--}}
                                ...
                                {{--                                    <img src="{{asset('public/frontend/acslmstheme/svg/image.svg')}}" alt="">--}}
                                ...
                                {{--                                    <img src="{{asset('public/frontend/acslmstheme/svg/doc.svg')}}" alt="">--}}
                                ...
                                {{--                                    <img src="{{asset('public/frontend/acslmstheme/svg/code.svg')}}" alt="">--}}
                                ...
                                {{--                                    <img src="{{asset('public/frontend/acslmstheme/svg/gift.svg')}}" alt="">--}}
...
<script src="{{asset('public/frontend/acslmstheme/js/course-coupon.js')}}"></script>
