        ...
        <div class="container-fluild">
            <div class="row">
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="reward-card">
                        <div class="reward-card-points d-flex align-items-center">
                            <div class="img">
                                <img src="{{asset('public/frontend/acslmstheme/img/rewards')}}/1.png"
                                     alt="">
                            </div>
                            <div class="content">
                                <h4>
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="reward-card">
                        <div class="reward-card-points d-flex align-items-center">
                            <div class="img"><img src="{{asset('public/frontend/acslmstheme/img/rewards')}}/2.png"
                                                  alt=""></div>
                            <div class="content">
                                <h4> {{$total_remind}}</h4>
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="reward-card">
                        <div class="reward-card-points d-flex align-items-center">
                            <div class="img"><img src="{{asset('public/frontend/acslmstheme/img/rewards')}}/3.png"
                                                  alt=""></div>
                            <div class="content">
                                <h4> {{$total_earn}}</h4>
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="reward-card">
                        <div class="reward-card-points d-flex align-items-center">
                            <div class="img"><img src="{{asset('public/frontend/acslmstheme/img/rewards')}}/4.png"
                                                  alt=""></div>
                            <div class="content">
                                <h4> {{$total_spend}}</h4>
                        ...
                        <div class="reward-card w-100">
                            <div class="reward-blance d-flex flex-column flex-lg-row align-items-center flex-wrap">
                                <div class="reward-blance-img">
                                    <img src="{{asset('public/frontend/acslmstheme/img/rewards')}}/blance-img.png"
                                         alt="">
                                </div>
                    ...
                    <div class="col-xxl-4 col-xl-4 d-flex">
                        <div class="reward-card badge-card">
                            <div class="reward-badge text-center">
                                <div class="img">
                                    <img src="{{asset('public/frontend/acslmstheme/img/rewards/badge.png')}}"
                                         alt="">
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    <img src="{{asset('public/frontend/acslmstheme/img/rewards/exchange-img.png')}}" alt="">
