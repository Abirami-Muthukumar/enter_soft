<div>
    ...
    <div class="position-relative">
        <div class="course__details_head"
             style="background-image: url({{asset('/public/frontend/acslmstheme/img/course_details/header_bg.png')}})">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <p class="location">
                        ...
                        <ul class="d-flex gap-3 flex-wrap align-items-center meta">
                            ...
                            <li class="meta_item">
                                <div class="rating d-flex gap-1">
                                    ...
                                    @endfor
                                    @if ($main_stars>$stars)
                                        <img src="{{asset('public/frontend/acslmstheme/img/svg/half_star.svg')}}" alt="">
                                    @endif
                                    @if($main_stars==0)
                                        @for ($i = 0; $i <  5; $i++)
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
