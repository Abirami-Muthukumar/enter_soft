    ...
    <form action="{{ route('search') }}">
        <div class="banner-area">
            <div class="banner-img">
                <img src="{{ asset('public/frontend/acslmstheme/img/banner/banner-v5.svg')}}" class="d-none d-md-block" alt="">
                <img src="{{ asset('public/frontend/acslmstheme/img/banner/banner-v5-m.svg')}}" class="d-md-none" alt="">
            </div>
