...
@section('title')
    {{Settings('site_title')  ? Settings('site_title')  : 'acs LMS'}} | {{__('profile.profile')}}
@endsection
@section('css')
    ...
    {{--    <link href="{{asset('public/frontend/acslmstheme/css/myProfile.css')}}{{assetVersion()}}" rel="stylesheet"/>--}}
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/acslmstheme/css/student_profile.css')}}{{assetVersion()}}">
    <style>
...
@section('js')
    ...
    <script src="{{ asset('public/frontend/acslmstheme') }}/js/gijgo.min.js"></script>
    <!-- tag input css -->
