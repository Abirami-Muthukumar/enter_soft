            ...
            <form action="{{route('users.social_info.update')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mt_20">
                    ...
                    <div class="col-lg-6">
                        ...
                        <label class="primary_label2" for="linkedin">Share Your LinkedIn Profile Link</label>

                        <input id="linkedin" name="linkedin" placeholder="LinkedIn Profile URL"

                               onfocus="this.placeholder = ''"

                               onblur="this.placeholder = 'LinkedIn Profile URL'"
                ...
                <div class="row mt_20">
                    ...
                    <div class="col-lg-6">
                        ...
                        <label class="primary_label2" for="twitter">Share Your X Profile Link</label>

                        <input id="twitter" name="twitter" placeholder="X Profile URL"

                               onfocus="this.placeholder = ''"

                               onblur="this.placeholder = 'X Profile URL'"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <label class="primary_label2" for="facebook">Share Your Facebook Profile Link</label>

                        <input id="facebook" name="facebook" placeholder="Facebook Profile URL"

                               onfocus="this.placeholder = ''"

                               onblur="this.placeholder = 'Facebook Profile URL'"
