        ...
        <script>
            ...
            function updateCourseList() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        $("#course").empty();
                        $(".offlineCourseSelect .acs_ul_lists li").empty();
                        ...
                        $.each(data, function (i, item) {
                           var title =JSON.parse(item.title);
                            ...
                            $(".offlineCourseSelect  .acs_ul_lists").append(' <li data-search-term="' + title[lang] + '">\n' +
            ...
            function updateClassList() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        $("#class").empty();
                        $(".offlineClassSelect .acs_ul_lists li").empty();
                        ...
                        $.each(data, function (i, item) {
                            ...
                            $(".offlineClassSelect .acs_ul_lists").append(' <li data-search-term="' + title + '">\n' +
