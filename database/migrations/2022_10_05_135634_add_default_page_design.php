...
class AddDefaultPageDesign extends Migration
{
    public function up()
    {
        ...
        $link = base_path('resources/views/frontend/acslmstheme/snippets/pages/*.blade.php');
        $pages = glob($link);
        foreach ($pages as $page) {
            ...
            $content = \response()->view('frontend.acslmstheme.snippets.pages.' . $filename)->content();;
    ...
    private function addBanner($page)
    {
        try {
            ...
            $content = \response()->view('frontend.acslmstheme.components.breadcrumb', $data)->content();
